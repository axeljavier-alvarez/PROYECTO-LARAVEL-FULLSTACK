...
<?php $component->withAttributes(['class' => 'mt-12']); ?>
        <div class="flex justify-center">
            <img src="<?php echo e(asset('img/mensajes/gracias_compra.jpg')); ?>" alt="Gracias por tu compra"
                 class="w-80">
        </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\codersfree\resources\views/gracias.blade.php ENDPATH**/ ?>