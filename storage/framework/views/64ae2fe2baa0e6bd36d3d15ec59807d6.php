...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['wire:model' => 'name','class' => 'w-full','placeholder' => 'Ingrese el nombre de la sección']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'name','class' => 'w-full','placeholder' => 'Ingrese el nombre de la sección']); ?>
...
<?php endif; ?>
    ...
    </form><?php /**PATH C:\laragon\www\codersfree\resources\views\instructor\sections\create.blade.php ENDPATH**/ ?>