...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['wire:model' => 'lessonEdit.name','class' => 'flex-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'lessonEdit.name','class' => 'flex-1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="flex gap-4 mt-2 md:mt-0 md:ml-4 text-gray-600">
        ...
        <button wire:click="edit(<?php echo e($lesson->id); ?>)">
            <i class="fas fa-edit hover:text-indigo-600"></i>
        </button>

        <button x-on:click="destroyLesson(<?php echo e($lesson->id); ?>)">
