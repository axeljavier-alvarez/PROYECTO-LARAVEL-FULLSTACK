        ...
        <div class="col-span-1">
            <?php if($course->video_path): ?>
                <div wire:ignore>
                    <div x-data x-init="let player = new Plyr($refs.player);">
                        <video x-ref="player" class="aspect-video" playsinline controls data-poster="<?php echo e($course->image); ?>">
            ...
            <?php else: ?>
                <div x-data x-init="new Plyr($refs.player)">
                    <video x-ref="player" class="aspect-video" controls playsinline>
                        <source src="<?php echo e(asset('storage/courses/promotional-videos/course_video.mp4')); ?>"
                            type="video/mp4">
                    </video>
                </div>
            <?php endif; ?>
